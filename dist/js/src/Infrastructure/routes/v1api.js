...
exports.default = (function (app) {
    ...
    // BY LOCATION
    //
    app.use("/v1/location", express_1.default.json(), (0, express_async_handler_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var location_1, r, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    location_1 = req.body.location || req.url;
                    return [4 /*yield*/, LocationService.getLocationByIp(location_1)];
                case 2:
                    r = _a.sent();
                    if (r) {
                        response.ok(res, r);
